...
if [ "$(redis-cli -h 127.0.0.1 -p 6379 DBSIZE)" -eq 0 ]; then
    ...
    redis-cli -h 127.0.0.1 -p 6379 "HMSET" "CURRENT_ACAD_YEAR" "absexp" "-1" "sldexp" "-1" "data" "2024"
    redis-cli -h 127.0.0.1 -p 6379 "HMSET" "ACAD_YEAR_OPEN" "absexp" "-1" "sldexp" "-1" "data" "true"
    redis-cli -h 127.0.0.1 -p 6379 "HMSET" "NEXT_STUDENT_SUFIX" "absexp" "-1" "sldexp" "-1" "data" "0001"
